...
使用 phpmyadmin 在資料庫內建立新資料庫
資料庫名稱web2017
編碼與排序選擇utf8_geneal_ci
建立完成後
在資料庫執行SQL查詢
...
在visual studio code 新增檔案 vote2.php
...
在visual studio code 新增檔案 confirm2.php
修改confirm2.php加入是否投過票
reguire-once"db_func2.php"
Frow = check voted ($var1)
資料庫server120.108.112.179 改為 localhost
...
在visual studio code 新增檔案 db_func2.php
修改 db_func2.php
...
在visual studio code 新增檔案 save2.php(ver.2)
...
在visual studio code 新增檔案 db_func3.php
修改 db_func3.php
'username' => 'student2017'
'password' => 'mALL7Fs2E7hcuXsD'
'host' => '120.108.112.179'
...
在visual studio code 新增檔案 list2.php
...
在visual studio code 新增檔案 db_func4.php
修改 db_func4.php
'username' => 'student2017'
'password' => 'mALL7Fs2E7hcuXsD'
'host' => '120.108.112.179'
